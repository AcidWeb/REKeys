...
L["Respond to !keys queries on the guild chat"] = "Отвечать на запросы !keys в чате гильдии"
L["Respond to !keys queries on the group/raid chat"] = "Отвечать на запросы !keys в чате группы/рейда"
...
L["Xal'atath's Bargain"] = "Сделка с Ксал'атат"
